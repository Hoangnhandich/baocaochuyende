...
$username = "b33_37017408";
$password = "123123";
$dbname = "b33_37017408_sunshineshop";
...
<form action="login.php" method="post" class="relog">
    <div class="relog-form">
        ...
        <p class="relog-form__title">Nếu bạn chưa có tài khoản, <a href="register.php" class="relog-form__link">đăng ký</a> tại đây</p>
        ...
        <a href="password_forget.php" class="relog-form__btn-forget">Quên mật khẩu?</a>
        <a title="Quay trở về trang chủ" href="index.php" class="relog-form__back-icon">
