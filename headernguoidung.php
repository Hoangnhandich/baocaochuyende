...
<head>
    ...
    <script type="text/javascript" src="https://cdn.fchat.vn/assets/embed/webchat.js?id=66ab3303093b43284c33aa26" async="async"></script>
</head>
<style>
            ...
            <div class="grid wide">
                <div class="header-top">
                        <div class="header-top__gr">
                            <h1 style="color:red;">Sunshine Shop</h1>
                            ...
                            <div class="header-bottom__call">
                                <span class="header-bottom__call-msg">
                                    ...
                                    <span class="header-bottom__call-msg-text">
                                        Số điện thoại:
                                        <a href="tel:0989 17 8083" class="header-bottom__call-msg-num">0989 17 8083</a>
                                    </span>
                                </span>
                            </div>
                        </div>
